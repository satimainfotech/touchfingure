                    ...
                    <div class="col-lg-12 wow fadeInRight" data-wow-delay="0.3s">
						...
						?>
							...
							<div class="col-lg-12 col-xl-6">
								...
								<div class="col-lg-12 col-xl-6 6 taluka">
									<div class="form-floating">
                                ...
                                <div class="col-lg-12 col-xl-6 7 taluka_m">
									<div class="form-floating">
								...
								<div class="col-lg-12 col-xl-6 8 gram_panchayat">
									<div class="form-floating">
								...
								<div class="col-lg-12 col-xl-6 8 area">
									<div class="form-floating">
                               ...
                               <div class="col-lg-12 col-xl-6">
								...
								<div class="col-lg-12 col-xl-6">
								 ...
								 <div class="col-lg-12 col-xl-6 ">
								     <label id="fees_label" style="color:green;"></label>
									 <input type="hidden" class="form-control" id="fees" name="fees" placeholder="fees" >
									<div class="form-floating">
										<select id="payment_mode" name="payment_mode" placeholder="Select a payment_mode" class="form-control demo-chosen-select required" readonly >
								...
								<div class="col-12">
								 ...
								 <div class="col-lg-12 col-xl-4">
                                    <div class="form-floating">
                                       <input style="cursor: pointer;" type="file" name="profile_main_images" accept="image" id="profile_main_images" class="form-control" required>
                                        <label for="confirm_password">Profile Image</label>
                                    </div>
                                </div>
								<div class="col-lg-12 col-xl-4">
                                    <div class="form-floating">
                                       <input style="cursor: pointer;" type="file" name="adharcard_main_images" accept="image" id="adharcard_main_images" class="form-control" required>
                                        <label for="confirm_password">Adharcard Image</label>
                                    </div>
                                </div>
								<div class="col-lg-12 col-xl-4">
                                    <div class="form-floating">
                                       <input style="cursor: pointer;" type="file" name="pancard_main_images" accept="image" id="pancard_main_images" class="form-control" required>
  ...
  <div class="modal-dialog">
	...
	function get_state(country){
		...
		function get_taluka(district){
			...
			{
				var url = base_url+'register/get_taluka_m';
			}
			else
			{
				var url = base_url+'register/get_taluka';
			}
		...
		function get_gram_panchayat(taluka){
			...
			{
				var url = base_url+'register/get_gram_panchayat';
			}
