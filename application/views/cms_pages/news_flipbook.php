    ...
    <div class="container" id="container">
		...
		<?php /* <script type="text/javascript" src="<?=base_url('template/front/abdaily/flipbook/js/jquery.min.js')?>"></script>
		<script type="text/javascript" src="<?=base_url('template/front/abdaily/flipbook/js/html2canvas.min.js')?>"></script>
		<script type="text/javascript" src="<?=base_url('template/front/abdaily/flipbook/js/three.min.js')?>"></script>
		<script type="text/javascript" src="<?=base_url('template/front/abdaily/flipbook/js/pdf.min.js')?>"></script>
		<script type="text/javascript" src="<?=base_url('template/front/abdaily/flipbook/js/3dflipbook.min.js')?>"></script> */ ?>
    ...
    /*  function theKingIsBlackPageCallback(n) {
      ...
      // // Sample 3 {
       $('#container').FlipBook({
         pdf: 'books/pdf/akhand_bharat.pdf',
         propertiesCallback: function(props) {
