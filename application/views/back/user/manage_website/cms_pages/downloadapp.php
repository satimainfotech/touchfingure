<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('download_app');?></h1>
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								foreach($downloadapp_data as $row){
							?>
								<?php
									echo form_open(base_url() . 'admin/manage_website/update_downloadapp/' . $row['downloadapp_id'], array(
													...
													<div id="vendor_details" class="tab-pane fade active in">
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingallzero">
															...
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 paddingrightzero">
																...
																<div class="form-group">
																	<label class="col-sm-12 control-label" for="demo-hor-1"><?php echo translate('download_app_link');?></label>
																	<div class="col-sm-12">
																		<input type="text" name="download_app_link" id="demo-hor-1" placeholder="<?php echo translate('download_app_link');?>" class="form-control " value="<?php echo $row['download_app_link']; ?>">
																	</div>
																</div>
															</div>
														</div>
