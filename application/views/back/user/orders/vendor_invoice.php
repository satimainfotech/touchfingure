        ...
        <div class="row">
            <div class="fulldiv">
                <div class="invoice_body">
                    ...
                    <div class="row">
						<?php $v_name = $this->db->get_where('vendor',array('vendor_id'=>$user_id))->row()->name; $s_name = $this->db->get_where('vendor',array('vendor_id'=>$user_id))->row()->company;?>
						<h4 class="vendornamefont"><b>Vendor Name : </b><?php echo $v_name; ?> ( <?php echo $s_name; ?> ) </h4>
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tbody>
                                        <?php
											...
											if($this->crud_model->is_added_by('product',$row1['id'],$user_id)){
												$i++;
										?>
                                        <tr class="<?= ($counter % 2 == 0) ? 'even' : 'odd' ?>">
                                            ...
                                            <td class="text-right">
												...
												echo currency($price*$row1['qty']); 
													...
													$discount_total += $row1['discounted_amount']*$row1['qty'];
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-line text-right-align totalbgp">
                                            	<?php echo currency('','def').$this->cart->format_number(($total-$discount_total)+$vat+$shipping); ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
