<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('user_edit');?></h1>
		<a class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right custombutton" href="<?php echo base_url(); ?>login/idcard"><?php echo translate('Id card');?> </a>
		<a class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right custombutton" href="<?php echo base_url(); ?>login/letter"><?php echo translate('Letter');?> </a>
		<a class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right custombutton" href="<?php echo base_url(); ?>login/visitingcard"><?php echo translate('visitingcard');?> </a>
		<a class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right custombutton" href="<?php echo base_url(); ?>login/congratulations"><?php echo translate('congratulations');?> </a>
	</div>
        <div class="tab-base">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in">
						...
						?>
						<?php
							echo form_open(base_url() . 'admin/abdaily/user/user_update/' . $row['id'], array(
