<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('create_new_district');?></h1>
		<?php
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in">
						<?php
							echo form_open(base_url() . 'mind1992gameadmin/master_manage/district_added/', array(
