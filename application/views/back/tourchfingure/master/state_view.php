<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('state_details');?></h1>
		<?php
			if(@$country != '' || @$state != ''){
		?>
									...
									<div class="panel-body view_table">
										<table class="table table-striped talbeMRb" style="border-radius:3px;">
											<tr>
												...
												<td class="custom_td"><div class="label label-<?php if($row['state_status'] == 'active'){ ?>purple<?php } else { ?>danger<?php } ?>"><?php echo $row['state_status']; ?></div></td>
											</tr>
											<tr>
