<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('city_details');?></h1>
		<?php
									...
									<div class="panel-body view_table">
										<table class="table table-striped talbeMRb" style="border-radius:3px;">
											<tr>
												...
												<td class="custom_td"><div class="label label-<?php if($row['city_status'] == 'active'){ ?>purple<?php } else { ?>danger<?php } ?>"><?php echo $row['city_status']; ?></div></td>
											</tr>
											<tr>
