...
?>
    <div class="tab-pane fade active in" id="edit">
        <?php
			echo form_open(base_url() . 'admin/staff/admins/update/' . $row['admin_id'], array(
		...
		?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="password" name="password" value="<?php echo $row['orignal_password']; ?>" id="demo-hor-3" class=" form-control required" placeholder="<?php echo translate('password'); ?>">
                    </div>
                </div>
                <div class="form-group">
...
<script>
	...
	$(".emails").blur(function(){
		...
		$.post("<?php echo base_url(); ?>admin/staff/exists",
		{
