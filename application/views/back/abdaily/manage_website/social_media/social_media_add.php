<div id="content-container">
	<div id="page-title">
		...
		<a class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn custombutton" href="<?php echo base_url(); ?>admin/abdaily/manage_website/social_media<?php if(@$page_id == ''){ }else{ echo "?page=$page_id"; } ?>"><?php echo translate('back');?> </a>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								echo form_open(base_url() . 'admin/abdaily/manage_website/social_media_do_add/', array(
							...
							?>
								...
								<div class="panel-footer">
									<div class="row">
										...
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="ajax_form_submit('social_media_add','<?php echo translate('social_media_has_been_added!'); ?>','abdaily/manage_website/social_media');"><?php echo translate('submit');?></span>
									</div>
								</div>
							</form>
						</div>
