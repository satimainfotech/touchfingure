				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								echo form_open(base_url() . 'admin/abdaily/manage_website/our_technology_do_add/', array(
							...
							?>
											...
											<div class="tab-content">
												<div id="vendor_details" class="tab-pane fade active in">
														<div class="form-group">
															...
															<div class="col-sm-10">
																<input type="text" name="our_technology_title" id="demo-hor-1" placeholder="<?php echo translate('title');?>" class="form-control required">
															</div>
														</div>
														<div class="form-group">
															<label class="col-sm-2 control-label" for="demo-hor-1"><?php echo translate('title');?></label>
															<div class="col-sm-10">
																<textarea type="text" name="our_technology_description" id="demo-hor-1" placeholder="<?php echo translate('Description');?>" class="form-control required"></textarea>
															</div>
														</div>
														<div class="form-group">
								...
								<div class="panel-footer">
									<div class="row">
										...
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="ajax_form_submit('our_technology_add','<?php echo translate('our_technology_has_been_added!'); ?>','abdaily/manage_website/our_technology');"><?php echo translate('submit');?></span>
									</div>
								</div>
							</form>
						</div>
