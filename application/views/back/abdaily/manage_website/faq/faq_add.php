				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								echo form_open(base_url() . 'admin/abdaily/manage_website/faq_do_add/', array(
							...
							?>
								...
								<div class="panel-footer">
									<div class="row">
										...
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="ajax_form_submit('faq_add','<?php echo translate('faq_has_been_added!'); ?>','abdaily/manage_website/faq');"><?php echo translate('submit');?></span>
									</div>
								</div>
							</form>
						</div>
