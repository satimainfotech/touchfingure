<div id="content-container">
	<div id="page-title">
		...
		<input type="hidden" value="<?php echo base_url(); ?>admin/abdaily/manage_website/payment_receipt" id="return_url">
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							...
							?>
								<?php
									echo form_open(base_url() . 'admin/abdaily/manage_website/payment_receipt_update/' . $row['payment_receipt_id'], array(
