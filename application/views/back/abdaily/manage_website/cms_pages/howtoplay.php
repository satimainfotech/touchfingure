<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('how to play');?></h1>
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								foreach($howtoplay_data as $row){
							?>
								<?php
									echo form_open(base_url() . 'admin/abdaily/manage_website/update_howtoplay/' . $row['howtoplay_id'], array(
													...
													<div id="vendor_details" class="tab-pane fade active in">
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingallzero">
															<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 paddingleftzero">
																...
																<div class="form-group">
																	<label class="col-sm-12 control-label" for="demo-hor-1"><?php echo translate('video_url');?></label>
																	<div class="col-sm-12">
																		<input type="text" name="video_url" id="demo-hor-1" placeholder="<?php echo translate('video_url');?>" class="form-control " value="<?php echo $row['video_url']; ?>">
																	</div>
																</div>
															</div>
