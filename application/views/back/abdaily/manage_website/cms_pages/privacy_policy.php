<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('privacy_policy');?></h1>
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								foreach($privacypolicy_data as $row){
							?>
								<?php
									echo form_open(base_url() . 'admin/abdaily/manage_website/update_privacy_policy/' . $row['privacypolicy_id'], array(
