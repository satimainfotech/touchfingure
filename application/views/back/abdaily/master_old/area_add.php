<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('create_new_area');?></h1>
		<?php
		...
		?>
			...
			<input type="hidden" value="<?php echo base_url(); ?>admin/abdaily/master_manage/area?c_i=<?php echo @$country; ?>&s_i=<?php echo @$state; ?>&d_i=<?php echo @$district; ?>&ct_i=<?php echo @$city; ?>&a_n=<?php echo @$area; ?><?php if(@$page_id == ''){ }else{ echo "&page=$page_id"; } ?>" id="page_return_url">
		<?php }else{ ?>
			<a class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn custombutton" href="<?php echo base_url(); ?>admin/abdaily/master_manage/area<?php if(@$page_id == ''){ }else{ echo "?page=$page_id"; } ?>"><?php echo translate('back');?> </a>
			<input type="hidden" value="<?php echo base_url(); ?>admin/abdaily/master_manage/area<?php if(@$page_id == ''){ }else{ echo "?page=$page_id"; } ?>" id="page_return_url">
		<?php } 
		?>
	</div>
        <div class="tab-base">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in">
						<?php
							echo form_open(base_url() . 'admin/abdaily/master_manage/area_added/', array(
						...
						?>
										...
										<div class="tab-content">
											<div id="vendor_details" class="tab-pane fade active in">
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddingfive">
													...
													<div class="form-group">
														<label class="col-sm-3 control-label" for="demo-hor-2"><?php echo translate('city');?></label>
														<div class="col-sm-9" id="city_data">
															<select name="city" class="demo-chosen-select" data-placeholder="Choose a city" id="city">
													...
													<div class="form-group">
														...
														<div class="col-sm-9 paddingfive">
															<input type="text" name="area_name" id="demo-hor-1" placeholder="<?php echo translate('area_name');?>" class="form-control required">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label paddingfive" for="demo-hor-1"><?php echo translate('zip_code');?></label>
														<div class="col-sm-9 paddingfive">
															<input type="text" name="zip_code" id="demo-hor-1" placeholder="<?php echo translate('zip_code');?>" class="form-control required">
														</div>
													</div>
												</div>
											</div>
							...
							<div class="panel-footer">
								<div class="row">
									...
									<div class="col-md-10">
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="master_manage_submit('area_add','<?php echo translate('area_successfully_created!'); ?>');" ><?php echo translate('submit');?></span>
									</div>
								</div>
							</div>
						</form>
