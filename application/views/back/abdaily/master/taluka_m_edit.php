<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('edit_taluka_m');?></h1>
		<?php
                ...
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in">
						<?php
							...
							echo form_open(base_url() . 'admin/abdaily/master_manage/taluka_m_update/'. $row['taluka_id'], array(
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddingfive">
													...
													<div class="form-group">
														...
														<div class="col-sm-9 paddingfive">
															<input type="text" name="taluka_name" id="demo-hor-1" placeholder="<?php echo translate('taluka_name');?>" class="form-control required" value="<?php echo $row['taluka_m_name'];?>">
														</div>
													</div>
												</div>
											</div>
