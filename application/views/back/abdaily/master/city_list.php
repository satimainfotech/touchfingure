				...
				<?php if($this->crud_model->admin_permission('city_edit') || $this->crud_model->admin_permission('city_delete')){?>
					<td class="text-right">
						<?php if($this->crud_model->admin_permission('city_edit')){?>
							<a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/abdaily/master_manage/city/edit/<?php echo $row['city_id']; ?>" > <?php echo translate('edit');?> </a>
						<?php } ?>
