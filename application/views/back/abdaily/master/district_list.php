				...
				<?php if($this->crud_model->admin_permission('district_edit') || $this->crud_model->admin_permission('district_delete')){?>
					<td class="text-right">
						<?php if($this->crud_model->admin_permission('district_edit')){?>
							<a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" href="<?php echo base_url(); ?>admin/abdaily/master_manage/district/edit/<?php echo $row['district_id']; ?>" > <?php echo translate('edit');?> </a>
						<?php } ?>
