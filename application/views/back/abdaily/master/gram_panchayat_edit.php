<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('edit_gram_panchayat');?></h1>
		<?php
                ...
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in">
						<?php
							...
							echo form_open(base_url() . 'admin/abdaily/master_manage/gram_panchayat_update/'. $row['gram_panchayat_id'], array(
								'class' => 'form-horizontal',
								'method' => 'post',
								'id' => 'gram_panchayat_edit',
						...
						?>
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddingfive">
													<div class="form-group">
														...
														<select name="taluka_m" class="demo-chosen-select" data-placeholder="Choose a Taluka_m" id="taluka_m" onchange="select_country(this.value)">
																...
																if($t_row['taluka_id'] == $row['taluka_id']){
													...
													<div class="form-group">
														...
														<div class="col-sm-9 paddingfive">
															<input type="text" name="gram_panchayat_name" id="demo-hor-1" placeholder="<?php echo translate('gram_panchayat_name');?>" class="form-control required" value="<?php echo $row['gram_panchayat_name'];?>">
														</div>
													</div>
												</div>
											</div>
							...
							<div class="panel-footer">
								<div class="row">
									...
									<div class="col-md-10">
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="master_manage_submit('gram_panchayat_edit','<?php echo translate('gram_panchayat_successfully_updated!'); ?>');" ><?php echo translate('submit');?></span>
									</div>
								</div>
							</div>
						</form>
...
<script>
	...
	var selected_country = '<?php echo $gram_panchayat_data[0]["country_id"]; ?>';
	var selected_state = '<?php echo $gram_panchayat_data[0]["state_id"]; ?>';
	var selected_district = '<?php echo $gram_panchayat_data[0]["district_id"]; ?>';
	var selected_city = '<?php echo $gram_panchayat_data[0]["city_id"]; ?>';
