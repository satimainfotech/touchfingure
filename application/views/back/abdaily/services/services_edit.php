<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('edit_services');?></h1>
		<?php if(@$services != ''){ ?>
			...
			<input type="hidden" value="<?php echo base_url(); ?>admin/abdaily/services?c_n=<?php echo @$services; ?><?php if(@$page_id == ''){ }else{ echo "&page=$page_id"; } ?>" id="return_url">
		<?php }else{ ?>
			...
			<input type="hidden" value="<?php echo base_url(); ?>admin/abdaily/services<?php if(@$page_id == ''){ }else{ echo "?page=$page_id"; } ?>" id="return_url">
		<?php } ?>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							...
							?>
								<?php
									echo form_open(base_url() . 'admin/abdaily/services/services_update/' . $row['services_id'], array(
													...
													<div id="vendor_details" class="tab-pane fade active in">
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<div class="form-group ">
																...
																<div class="col-sm-10">
																	<input type="text" name="services_name" id="demo-hor-1" placeholder="<?php echo translate('name');?>" class="form-control" value="<?php echo $row['services_name']; ?>">
																</div>
															</div>
															<div class="form-group ">
																<label class="col-sm-2 control-label" for="demo-hor-1"><?php echo translate('services_description');?></label>
																<div class="col-sm-10">
																	<input type="text" name="services_description" id="demo-hor-1" placeholder="<?php echo translate('services_description');?>" class="form-control" value="<?php echo $row['services_description']; ?>">
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-sm-10">
																	...
																	<span id='services_image_wrap' class=" show_iin_image" style="width: 200px;float:right; border:1px solid #ddd;border-radius:5px;padding:5px">
																		<?php
																		if($row['services_image'] != ''){
																			if(file_exists('uploads/abdaily_services_image/'.$row['services_image'])){
																		?>
																			<img src="<?php echo base_url(); ?>uploads/abdaily_services_image/<?php echo $row['services_image']; ?>" width="100%" id='services_image_blah' />  
																		<?php
																			} else {
																		?>
																			<img src="<?php echo base_url(); ?>uploads/abdaily_services_image/default.jpg" width="100%" id='services_image_blah' />
																		<?php
																			}
																		}else{?>
																			<img src="<?php echo base_url(); ?>uploads/abdaily_services_image/default.jpg" width="100%" id='services_image_blah' />
															...
															<div class="form-group">
																...
																<div class="col-sm-10">
																	...
																	<span id='services_image_wrap' class=" show_iin_image" style="width: 200px;float:right; border:1px solid #ddd;border-radius:5px;padding:5px">
																		<?php
																		if($row['services_inner_image'] != ''){
																			if(file_exists('uploads/abdaily_services_inner_image/'.$row['services_inner_image'])){
																		?>
																			<img src="<?php echo base_url(); ?>uploads/abdaily_services_inner_image/<?php echo $row['services_inner_image']; ?>" width="100%" id='services_image_blah' />  
																		<?php
																			} else {
																		?>
																			<img src="<?php echo base_url(); ?>uploads/abdaily_services_image/default.jpg" width="100%" id='services_image_blah' />
