				...
				<div class="tab-content">
					<div class="tab-pane fade active in" id="list">
						<div class="viewpages panel-body">
							<?php
								echo form_open(base_url() . 'admin/abdaily/news/news_do_add/', array(
							...
							?>
												...
												<div id="vendor_details" class="tab-pane fade active in">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="form-group ">
															...
															<div class="col-sm-4">
																<input type="date" name="news_name" id="demo-hor-1" placeholder="<?php echo translate('name');?>" class="form-control">
															</div>
														</div>
								...
								<div class="panel-footer">
									<div class="row">
										...
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="ajax_form_submit('news_add','<?php echo translate('news_has_been_added!'); ?>','abdaily/news');"><?php echo translate('submit');?></span>
									</div>
								</div>
							</form>
						</div>
