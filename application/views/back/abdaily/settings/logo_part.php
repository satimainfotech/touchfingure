<div id="page-title">
	<h1 class="page-header text-overflow custompagetitle"><?php echo translate('upload_logo');?></h3>
	</h1>
</div>
<div class="col-md-4 col-sm-4 singlepageinnbg">
	<?php
		echo form_open(base_url() . 'admin/display_settings/logo_settings/upload_logo1', array(
...
<div class="col-md-8 col-sm-8 singlepageinnbg">
	<div class="panel">
...
<form >
	<div class="col-md-12 singlepageinnbg">
		<div class="panel">
			...
			<?php
				$admin_login_logo = $this->db->get_where('general_settings',array('type' => 'admin_login_logo'))->row()->value;
				$admin_nav_logo = $this->db->get_where('general_settings',array('type' => 'admin_nav_logo'))->row()->value;
				$home_top_logo = $this->db->get_where('general_settings',array('type' => 'home_top_logo'))->row()->value;
				$home_bottom_logo = $this->db->get_where('general_settings',array('type' => 'home_bottom_logo'))->row()->value;
			?>
...
<script>
function load_logos(){
	ajax_load('<?php echo base_url(); ?>admin/display_settings/logo_settings/show_all','list','');
}
