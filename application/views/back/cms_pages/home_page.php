...
?>
        ...
        <div class="meeta-hero-section" style="background-image: url(<?php echo base_url(); ?>uploads/images/slider-1.jpg);">

            <img class="hero-shape-01" src="<?php echo base_url(); ?>uploads/images/shape/shape-1.svg" alt="shpae">
            <img class="hero-shape-02" src="<?php echo base_url(); ?>uploads/images/shape/shape-2.png" alt="shpae">
            ...
            <div class="container">
                <div class="meeta-hero-content">
                    ...
                    <h3 class="hero-title" data-aos-delay="700" data-aos="fade-up"><?php echo $event_register_data[0]['event_name'];?></h3>
                    <span class="hero-year" data-aos-delay="800" data-aos="fade-right"><?php echo $event_register_data[0]['start_date'];?></span>
                    <p class="hero-date" data-aos-delay="900" data-aos="fade-up"><?php echo $event_register_data[0]['address'];?></p>
                </div>
            </div>
        </div>
        <!-- Slider Section End -->
        ...
        <div class="meeta-register-countdown">
            <div class="container position-relative">
                    ...
                    <div class="row gy-5 align-items-center">
                        <div class="col-lg-4">
                            ...
                            <div class="meeta-register">
							 <h4 class="register-address"><?php echo $event_register_data[0]['address'];?> </h4>
                                <h2 class="register-title">Register Today</h2>
                                <a class="register-btn btn btn-3 btn-outline-primary" href="<?php echo base_url(); ?>events/details/<?php echo $event_register_data[0]['event_id'];?>">Book Your Seat</a>
                            </div>
                            <!-- Register End -->
                        ...
                        <div class="col-lg-8">
                            ...
                            <!-- Countdown Start -->
                            <div class="meeta-countdown countdown" data-countdown="<?php echo date("Y/m/d",strtotime($event_register_data[0]['start_date']));?>" data-format="short">
                ...
                <img class="register-countdown-shape" src="<?php echo base_url(); ?>uploads/images/shape/shape-5.png" alt="Shape">
                ...
                <div class="row gy-5 justify-content-between">
                    <div class="col-lg-4">
                        ...
                        <div class="meeta-event-schedule-banner" style="background-image: url(assets/images/event-schedule.jpg);">
                            ...
                            <!-- Section Title End -->
                            <a href="#" class="btn btn-3 btn-primary">Download Schedule <i class="fa fa-download"></i></a>
                        </div>
                    ...
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <div class="meeta-event-schedule-tabs">
							...
							<?php $i = 1; foreach($event_data as $key=>$value){ ?>						
							
                                <li data-tab-target="#tab<?php echo $i; ?>"  <?php if($i == 1) { ?> class="active" <?php } ?>>
                                    <div class="meeta-event-schedule-time">
                                        <h4 class="meeta-event-schedule-day"><?php echo date("M d Y",strtotime($key)); ?></h4>
                                        <p>Oct 08, 2022</p>
                                    </div>
                                </li>								
							<?php $i++;} ?>
							...
							<?php $j = 1; foreach($event_data as $key=>$value){ ?>			
                                <div id="tab<?php echo $j; ?>" class="meeta-event-schedule-tab-pane <?php if($j == 1) { ?> active <?php } ?>">

                                    <!-- Event Accordion Start -->
                                    <ul class="meeta-event-accordion">
									<?php  foreach($value as $event_rows){ ?>			
                                        <li class="meeta-event-accordion-item">
                                            <h3 class="meeta-event-accordion-toggle">
                                                <span class="time"><?php echo $event_rows['event_time']; ?></span>
                                                <span class="title"><?php echo $event_rows['event_name']; ?> </span>
                                            </h3>
                                            <div class="meeta-event-accordion-body open">
                                                <p><?php echo $event_rows['description']; ?></p>
                                            </div>
                                        </li>
							...
							<div class="swiper-slide">
                                <div class="single-testimonial">
                                    <div class="testimonial-quote">
                                        ...
                                        <img src="<?php echo base_url(); ?>uploads/images/quote.svg" alt="Quote">
                                    </div>
                                    <p><?php echo $testominal_row['testimonials_desicription'];?></p>
                                    <h3 class="testimonial-name"><?php echo $testominal_row['testimonials_name'];?> <span><?php echo $testominal_row['designation'];?></span></h3>
                                </div>
