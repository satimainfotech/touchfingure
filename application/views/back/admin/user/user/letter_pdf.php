...
$html = '
	...
	<body>
		<table border="" >
			...
			<tr style="width:100%">
				<td colspan="2" class="header_right"><p>પત્ર ક્રમાંક :-______________ </p><p>તારીખ :- ______________ </p></td>
			</tr>
			<tr style="width:100%">
				<td  colspan="2" class="header_left"><p>પ્રતિ પોલીસ ઇન્સ્પેક્ટર શ્રી </p><p>______________પોલીસ સ્ટેશન</p><br></td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
	...
	<tr style="width:100%">
		...
		<table border="" class="second_table" >
			...
			<tr style="width:100%">
				<td colspan="2" class="header_right"><p>માનદ્દ નિમણૂક પત્ર  :- ABN2024000'.$user_detail['id'].'</p><p>તારીખ :-'.$user_detail['created_date'].' </p><p>પત્ર ક્રમાંક : :-______________</p></td>
			</tr>
