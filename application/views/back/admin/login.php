...
<body>
		...
		<div class="cls-content">
			<div class="cls-content-sm panel panel-colorful panel-login" style="margin-top: 50px !important;">
				<div class="panel-body">
					...
					<?php
						echo form_open(base_url().''.$control.'/login/logins/', array(
							'method' => 'post',
							'id' => 'login'
						));
					?>
	...
	<script src="<?php echo base_url(); ?>template/back/admin/js/common.min.js"></script>
	<script src="<?php echo base_url(); ?>template/back/admin/plugins/bootbox/bootbox.min.js"></script>
	<script src="<?php echo base_url(); ?>template/back/admin/js/ajax_login.js"></script>
