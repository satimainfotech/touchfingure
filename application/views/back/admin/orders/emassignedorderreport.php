							...
							<table class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th><?php echo translate('End Date');?></th>
									...
									foreach($all_sales as $as){ 
										?> 
									<tr>
										<td><?php echo $as['indent_no'];?></td>
										<td><?php echo $as['sr_no'];?></td>
										<td><?php echo $as['job_description'];?></td>
										<td><?php echo date('d-m-Y', strtotime($as['starttime']));?></td>
										<td><?php echo date('h:i:s A', strtotime($as['starttime']));?></td>
										<td><?php if($as['endtime']){ echo date('d-m-Y', strtotime($as['endtime'])); }?></td>										
										<td><?php if($as['endtime']){ echo date('h:i:s A', strtotime($as['endtime'])); }?></td>										
										<td><?php 
										if($as['endtime']){
										$totalMinutes = $as['total_time_spent_seconds'] * 60;
