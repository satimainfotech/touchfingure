            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in">
						<?php
							echo form_open(base_url() . 'admin/product/product_added/', array(
												...
												<div class="col-sm-6 col-md-6 col-xs-12 paddingleftzero">
													<div class="form-group">
														<div class="col-sm-6 col-xs-12 paddingzeroall">
															...
															<div class="col-sm-12">
																<select id="category" name="category_id" placeholder="Select a category" class="demo-chosen-select required" >
							...
							<div class="panel-footer">
								<div class="row">
									<div class="col-md-12 paddingzeroall">
										...
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="product_submit('product_add','<?php echo translate('product_has_been_added!'); ?>');" ><?php echo translate('upload');?></span>
									</div>
								</div>
							</div>
						</form>
