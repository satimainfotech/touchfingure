				...
				<?php if($this->crud_model->admin_permission('taluka_edit') || $this->crud_model->admin_permission('taluka_delete')){?>
					<td class="text-right">
						<?php if($this->crud_model->admin_permission('taluka_edit')){?>
							<a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" href="<?php echo base_url(); ?>admin//master_manage/taluka/edit/<?php echo $row['taluka_id']; ?>" > <?php echo translate('edit');?> </a>
						<?php } ?>
