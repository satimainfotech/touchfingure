<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow custompagetitle"><?php echo translate('create_new_Material');?></h1>
		<?php
			if(@$country != ''){
		?>
						...
						?>
											...
											<div id="vendor_details" class="tab-pane fade active in">
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddingfive">
													<div class="form-group">
														...
														<div class="col-sm-10 paddingfive">
															<input type="text" name="length" id="demo-hor-1" placeholder="<?php echo translate('Length');?>" class="form-control required">
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddingfive">
													<div class="form-group">
														...
														<div class="col-sm-10 paddingfive">
															<input type="text" name="width" id="demo-hor-1" placeholder="<?php echo translate('Width');?>" class="form-control required">
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 paddingfive">
													<div class="form-group">
														...
														<div class="col-sm-10 paddingfive">
															<input type="text" name="thickness" id="demo-hor-1" placeholder="<?php echo translate('thickness');?>" class="form-control required">
														</div>
													</div>
												</div>
											</div>
							...
							<div class="panel-footer">
								<div class="row">
									...
									<div class="col-md-10">
										<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left enterer" onclick="master_manage_submit('country_add','<?php echo translate('material_successfully_created!'); ?>');" ><?php echo translate('submit');?></span>
									</div>
								</div>
							</div>
						</form>
