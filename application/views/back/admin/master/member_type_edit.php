																...
																<span style="width: 50%;float:left; border:1px solid #ddd;border-radius:5px; padding:5px;margin-top:10px;" id="pofile_main_images_wrap">
																	...
																	<?php
																		...
																		if($row['profile_image'] != ''){
																			if(file_exists('uploads/drawing/'.$row['profile_image'])){
																		?>
																			<img src="<?php echo base_url(); ?>uploads/drawing/<?php echo $row['profile_image']; ?>" width="100%" id="profile_main_images_blah" />  
																		<?php
																			} else {
																		?>
