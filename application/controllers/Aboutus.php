   ...
   public function index()
    {
		...
		$data["content"] = @$content_data[0]['content'];
		...
		$data['team_data'] = $this->db->order_by('team_position','asc')->get_where('team_master',array('team_status'=>'Active'))->result_array();
		...
		$data["main_content"] = "cms_pages/aboutus";
		$data["form_msg"] = "";
