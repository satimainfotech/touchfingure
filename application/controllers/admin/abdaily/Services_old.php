...
class Services extends CI_Controller
{
	...
	public function index()
    {
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$count_data = $this->service_model->get_total_brand_data_count($brand);
			...
			$data['all_brand'] = $this->service_model->get_total_brand_data($brand,$config["per_page"],$page);
	...
	function brand_edit(){
		...
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$page_data['brand_data'] = $this->service_model->get_brand_details($brand_id,$brand_token);
