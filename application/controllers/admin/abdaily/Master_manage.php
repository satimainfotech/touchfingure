...
class Master_manage extends CI_Controller
{
	...
	public function district()
    {
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/master_manage/district".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function member_type()
    {
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "abdaily/master_manage/member_type".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function division()
    {
		...
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/master_manage/division".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function district_m()
    {
		...
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/master_manage/district_m".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function taluka()
    {
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/master_manage/taluka".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function taluka_m()
    {
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/master_manage/taluka_m".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function gram_panchayat()
    {
		if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "abdaily/master_manage/gram_panchayat".$searchurl;
			$config['per_page'] = 20;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
