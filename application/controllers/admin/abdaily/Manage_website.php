...
class Manage_website extends CI_Controller
{
	...
	public function social_media()
    {
        if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config['base_url'] = base_url() . "admin/abdaily/manage_website/social_media";
			$config['per_page'] = 10;
	...
	public function sliders()
    {
        if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/manage_website/sliders";
			$config['per_page'] = 10;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
...
/* MANAGE testimonials */
	public function testimonials()
    {
        if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config['base_url'] = base_url() . "admin/abdaily/manage_website/testimonials";
			$config['per_page'] = 10;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function cms_pages($para1 = '', $para2 = '')
    {
       ...
       if ($this->session->userdata('admin_login') == 'yes') {
			...
			if($para1 == 'home_page' && $para2 == '1'){
				...
				$data['page_name_link'] = "cms_pages";
				$this->load->view('back/abdaily/index', $data);
			}else if($para1 == 'about_us' && $para2 == '1'){
				$data['about_us_data'] = @$this->db->get_where('aboutus',array('aboutus_id'=>'1'))->result_array();
				$data['page_name'] = "manage_website/cms_pages/about_us";
				$data['page_name_link'] = "cms_pages";
				$this->load->view('back/abdaily/index', $data);
			}
			else{
	...
	public function second_sliders()
    {
        if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/manage_website/second_sliders";
			$config['per_page'] = 10;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function our_technology()
    {
        if ($this->session->userdata('admin_login') == 'yes') {
			...
			$config = array();		
			$config['total_rows'] = count($count_data);
			$config['base_url'] = base_url() . "admin/abdaily/manage_website/our_technology";
			$config['per_page'] = 10;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
	...
	public function our_technology_do_add(){
		...
		$data['our_technology_description'] = $this->input->post('our_technology_description');
	...
	public function footer_setting_update($para1 = '', $para2 = '', $para3 = ''){
		...
		$data['address_title'] = $this->input->post('address_title');
		$data['whatsapp_message'] = $this->input->post('whatsapp_message');
	...
	public function faq()
    {
        if ($this->session->userdata('admin_login') == 'yes') {
			...
			$count_data = $this->manage_website_model->get_faq_data_count();
			
			$config = array();		
			$config['total_rows'] = $count_data;
			$config['base_url'] = base_url() . "admin/abdaily/manage_website/faq";
			$config['per_page'] = 10;
			$config['uri_segment'] = '3';
			$config['page_query_string']= TRUE;
			$config['query_string_segment'] = "page";
			...
			$data['all_faq'] = $this->manage_website_model->get_faq_data($config["per_page"],$page);
			$data["links"] = $this->pagination->create_links();
			$data['msg'] = "";		
			$data['total_rows'] = $config["total_rows"];
			$data['page_id'] = $page;
			$data['page_name'] = "manage_website/faq/faq";
            $data['page_name_link'] = "faq";
            $this->load->view('back/abdaily/index', $data);
        } else {
            $data['control'] = "admin";
            $this->load->view('back/admin/login',$data);
    ...
    public function faq_view(){
		if ($this->session->userdata('admin_login') == 'yes') {
			$faq_id = @$_GET['f_i'];
			$faq_token = @$_GET['f_t'];
			if (!$this->crud_model->admin_permission('faq_view')) {
				redirect(base_url() . 'admin');
			}
			
			$data['faq_data'] = $this->db->get_where('faq', array('faq_id' => $faq_id,'faq_token' => $faq_token))->result_array();
			$data['page_name'] = "manage_website/faq/faq_view";
            $data['page_name_link'] = "faq";
            $this->load->view('back/abdaily/index', $data);
        } else {
            $data['control'] = "admin";
    ...
    /*User Management */
    function faqs($para1 = '', $para2 = '', $para3 = '')
    {
		if (!$this->crud_model->admin_permission('faq')) {
            redirect(base_url() . 'admin');
        }
		...
		if ($para1 == 'delete') {
			$id = $this->input->post('id');
			$data['faq_status'] = 'delete';
            $this->db->where('faq_id',$id);
            $this->db->update('faq',$data);
			$this->db->trans_complete();
			if ($this->db->trans_status() === TRUE) {
				if($get_old_image_name != ''){
					$rpersonal = "uploads/faq_image/".$get_old_image_name;
					unlink($rpersonal);
				}
				echo 'done';
			}else{
            ...
            $this->db->update('faq', $data);
        }else if ($para1 == 'show_set') {
            $faq = $para2;
			if ($para3 == 'true') {
                $data['faq_show_on_home'] = 'yes';
            } else {
                $data['faq_show_on_home'] = 'no';
            }
            $this->db->where('faq_id', $faq);
            $this->db->update('faq', $data);
        }
	...
	public function faq_add(){
		if ($this->session->userdata('admin_login') == 'yes') {
			if (!$this->crud_model->admin_permission('faq_add')) {
				redirect(base_url() . 'admin');
			}
			$data['page_name'] = "manage_website/faq/faq_add";
            $data['page_name_link'] = "faq";
            $this->load->view('back/abdaily/index', $data);
        } else {
            $data['control'] = "admin";
	...
	public function faq_do_add(){
		...
		$data['faq_token'] = $token;
		$data['faq_name'] = $this->input->post('faq_name');
		$data['faq_desicription'] = $this->input->post('faq_desicription');
		$data['faq_status'] = 'yes';
	...
	public function faq_edit(){
		if ($this->session->userdata('admin_login') == 'yes') {
			$faq_id = @$_GET['f_i'];
			$faq_token = @$_GET['f_t'];
			if (!$this->crud_model->admin_permission('faq_edit')) {
				redirect(base_url() . 'admin');
			}
			$data['page_id'] = @$_GET['page'];
			$data['faq_data'] = $this->db->get_where('faq', array('faq_id' => $faq_id,'faq_token'=>$faq_token))->result_array();
			$data['page_name'] = "manage_website/faq/faq_edit";
            $data['page_name_link'] = "faq";
            $this->load->view('back/abdaily/index', $data);
        } else {
            $data['control'] = "admin";
	...
	public function faq_update($para1 = '', $para2 = '', $para3 = ''){
		$data['faq_name'] = $this->input->post('faq_name');
		$data['faq_desicription'] = $this->input->post('faq_desicription');
		
		$this->db->where('faq_id', $para1);
		$this->db->update('faq', $data);
		$this->db->trans_complete();
		if ($this->db->trans_status() === TRUE) {
			echo 'done';
	...
	public function header_setting(){
		if ($this->session->userdata('admin_login') == 'yes') {
			if (!$this->crud_model->admin_permission('header_settings_edit')) {
				redirect(base_url() . 'admin');
			}
			
			$data['header_data'] = $this->db->get_where('header_setting', array('header_id' =>"1"))->result_array();
			$data['page_name'] = "manage_website/header_setting/header_setting";
            $data['page_name_link'] = "header_setting";
            $this->load->view('back/abdaily/index', $data);
        } else {
            $data['control'] = "admin";
            $this->load->view('back/admin/login',$data);
	...
	public function header_setting_update($para1 = '', $para2 = '', $para3 = ''){
		$data['contact_one'] = $this->input->post('contact_one');
		$data['email'] = $this->input->post('email');
		$data['location'] = $this->input->post('location');
		$data['news'] = $this->input->post('news');		
		$this->db->where('header_id', $para1);
		$this->db->update('header_setting', $data);
		$this->db->trans_complete();
		if ($this->db->trans_status() === TRUE) {
			echo 'done';
		}else{
	...
	/* Header Settings *//* Payment Receipt Settings */
	
	public function payment_receipt(){
		if ($this->session->userdata('admin_login') == 'yes') {
			if (!$this->crud_model->admin_permission('payment_receipt_edit')) {
				redirect(base_url() . 'admin');
			}
			
			$data['header_data'] = $this->db->get_where('payment_receipt', array('payment_receipt_id' =>"1"))->result_array();
			$data['page_name'] = "manage_website/payment_receipt/payment_receipt";
            $data['page_name_link'] = "payment_receipt";
            $this->load->view('back/abdaily/index', $data);
        } else {
            $data['control'] = "admin";
            $this->load->view('back/admin/login',$data);
	...
	public function payment_receipt_update($para1 = '', $para2 = '', $para3 = ''){
		$data['company_name'] = $this->input->post('company_name');
		$data['website_name'] = $this->input->post('website_name');
		$data['office_address'] = $this->input->post('office_address');
		$data['customer_support'] = $this->input->post('customer_support');	
		$data['email'] = $this->input->post('email');
		$data['unit'] = $this->input->post('unit');
		$data['cin_number'] = $this->input->post('cin_number');
		...
		if($company_logo != '' && $company_logo != null){
			...
			$logo_image = @$this->db->get_where('payment_receipt',array('payment_receipt_id'=>$para1))->row()->company_logo;
			if($logo_image != ''){
				$rpersonal = "uploads/other_images/".$logo_image;
				if (file_exists($rpersonal)) {
					unlink($rpersonal);
			...
			$dirPath = "uploads/other_images/";
			$newFileName = $otp2."_company_logo.". $ext;
			
			if(move_uploaded_file($uploadedFile, $dirPath. $newFileName)){
				$data['company_logo'] = $otp2.'_company_logo.'.$ext;
			}
		}
		
			$company_main_logo = $_FILES['company_main_logo']['name'];
		if($company_main_logo != '' && $company_main_logo != null){
			$length = 6;
			$characters = '01234567899876543210';
			$charactersLength = strlen($characters);
			$randomString = '';
			...
			$logo_main_image = @$this->db->get_where('payment_receipt',array('payment_receipt_id'=>$para1))->row()->company_main_logo;
			if($logo_main_image != ''){
				$rpersonal = "uploads/other_images/".$logo_main_image;
				if (file_exists($rpersonal)) {
					unlink($rpersonal);
				} else {
			...
			$ext = pathinfo($company_main_logo, PATHINFO_EXTENSION);
			
			$uploadedFile = $_FILES['company_main_logo']['tmp_name']; 
			$dirPath = "uploads/other_images/";
			$newFileName = $otp2."_company_main_logo.". $ext;
			
			if(move_uploaded_file($uploadedFile, $dirPath. $newFileName)){
				$data['company_main_logo'] = $otp2.'_company_main_logo.'.$ext;
			}
		}
		
		
		
		$application_logo = $_FILES['application_logo']['name'];
		if($application_logo != '' && $application_logo != null){
			$length = 6;
			$characters = '01234567899876543210';
			$charactersLength = strlen($characters);
			$randomString = '';
			...
			$logo_image = @$this->db->get_where('payment_receipt',array('payment_receipt_id'=>$para1))->row()->application_logo;
			if($logo_image != ''){
				$rpersonal = "uploads/other_images/".$logo_image;
				if (file_exists($rpersonal)) {
					unlink($rpersonal);
			...
			$ext = pathinfo($application_logo, PATHINFO_EXTENSION);
			
			$uploadedFile = $_FILES['application_logo']['tmp_name']; 
			$dirPath = "uploads/other_images/";
			$newFileName = $otp2."_application_logo.". $ext;
			
			if(move_uploaded_file($uploadedFile, $dirPath. $newFileName)){
				$data['application_logo'] = $otp2.'_application_logo.'.$ext;
			}
		}
		$this->db->where('payment_receipt_id', $para1);
		$this->db->update('payment_receipt', $data);
		$this->db->trans_complete();
		if ($this->db->trans_status() === TRUE) {
			echo 'done';
		}else{
