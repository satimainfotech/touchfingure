...
class Master_manage extends CI_Controller
{
	...
	public function get_district_data(){
		...
		$html = "<select id='district' name='district' placeholder='Select a District ' class='demo-chosen-select required ' onchange='select_district(this.value);' ><option value=''>Select Disctrict</option>";
		foreach($district_data as $dist_data){
