...
{ 
    ...
    {
		$data['content_data'] = $this->db->get_where('privacypolicy',array('privacypolicy_id'=>'1'))->row()->content;
		$content_data = $this->db->get_where('privacypolicy',array('privacypolicy_id'=>'1'))->result_array();
		...
		$data["page_slug"] = "Privacy Policy";
		$data["page_class"] = "Privacy Policy";
		$data["main_content"] = "cms_pages/privacypolicy";
		$data["form_msg"] = "";
